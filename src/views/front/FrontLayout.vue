...
<div class="router">
  <n-row>
    <n-col>
      <n-button class="menu-button" @click="activate('left')">
      <n-icon><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 512 512"><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="32" d="M96 256h320"></path><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="32" d="M96 176h320"></path><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="32" d="M96 336h320"></path></svg></n-icon>
      </n-button>
      <n-drawer v-model:show="active" :width="250" :placement="placement" style="height:100vh">
        <n-drawer-content title="選單">
          <n-menu class="menu-s" v-model:value="activeKey" :options="menuOptions" />
        </n-drawer-content>
      </n-drawer>
    </n-col>
    <n-col>
       ...
       <n-grid cols="1 s:2 l:4" responsive="screen">
        <n-grid-item>
          <div class="footer-box">
            <img src="../../assets/logo.jpg" style="margin-left:auto;margin-right:auto;width: 100px;"><br>
            <h3>FENS DESSERT</h3><br>
            <h4>地址:新北市板橋區</h4> 
        ...
        <n-grid-item>
          <div class="footer-box">
            <h3 style="margin-bottom:30px">追蹤Fens Dessert</h3> 
