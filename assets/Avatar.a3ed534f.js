import{t as A,o as V}from"./utils.12d16166.js";import{c as K,aC as T,d as N,m as F,ab as G,q as O,ac as D,n as _,e as q,f as U,r as y,i as w,j as x,A as M,z as X,af as Y,B as J,aD as Q,k as Z,x as ee,l as oe,h as R,ah as re,V as te}from"./index.4ae3d2fe.js";const H=!1,ne=r=>{const{borderRadius:s,avatarColor:i,cardColor:t,fontSize:l,heightTiny:u,heightSmall:a,heightMedium:b,heightLarge:f,heightHuge:v,modalColor:h,popoverColor:d}=r;return{borderRadius:s,fontSize:l,border:`2px solid ${t}`,heightTiny:u,heightSmall:a,heightMedium:b,heightLarge:f,heightHuge:v,color:T(t,i),colorModal:T(h,i),colorPopover:T(d,i)}},ae={name:"Avatar",common:K,self:ne},se=ae,ie=N("n-avatar-group"),le=F("avatar",`
